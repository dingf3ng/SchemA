...
export function initializeBuiltins(glbEnv: Environment, outRef: string[]): Environment {
    ...
    glbEnv.define('MinHeap', {
        value: {
            fn: () => ({ value: new MinHeap<RuntimeTypedBinder>(), type: { static: { kind: 'heap', elementType: { kind: 'weak' } }, refinements: [] } }),
        },
    ...
    glbEnv.define('MaxHeap', {
        value: {
            fn: () => ({ value: new MaxHeap<RuntimeTypedBinder>(), type: { static: { kind: 'heap', elementType: { kind: 'weak' } }, refinements: [] } }),
        },
        type: { static: { kind: 'function', parameters: [], returnType: { kind: 'heap', elementType: { kind: 'weak' } } }, refinements: [] },
    });
    ...
    glbEnv.define('MinHeapMap', {
        value: {
            fn: () => ({ value: new MinHeapMap<RuntimeTypedBinder, RuntimeTypedBinder>(), type: { static: { kind: 'heapmap', keyType: { kind: 'weak' }, valueType: { kind: 'weak' } }, refinements: [] } }),
        },
    ...
    glbEnv.define('MaxHeapMap', {
        value: {
            fn: () => ({ value: new MaxHeapMap<RuntimeTypedBinder, RuntimeTypedBinder>(), type: { static: { kind: 'heapmap', keyType: { kind: 'weak' }, valueType: { kind: 'weak' } }, refinements: [] } }),
        },
        type: { static: { kind: 'function', parameters: [], returnType: { kind: 'heapmap', keyType: { kind: 'weak' }, valueType: { kind: 'weak' } } }, refinements: [] },
    });
